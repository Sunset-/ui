        ...
        if (
          ...
          if (!isNaN(this.inputValue)) {
            if (
              ...
              this.inputValue =
                Sunset.Numbers.fixed(this.options.min, this.digits) + "";
            }
            if (
              ...
              this.inputValue =
                Sunset.Numbers.fixed(this.options.max, this.digits) + "";
            }
          }
        }
      }
    ...
    valueToInputValue(v) {
      ...
      if (!this.lock) {
        ...
        if (this.prependSelect && ~v.indexOf(this.prependSpliter)) {
          ...
          v = v.substring(
            v.indexOf(this.prependSpliter) + this.prependSpliter.length,
            v.length
          );
        }
        //拆出后缀
